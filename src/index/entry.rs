...
impl JuneEntry {
  pub(crate) fn spaced_june(&self) -> SpacedJune {
    SpacedJune {
      june: self.june,
...
impl Entry for JuneEntry {
  type Value = JuneEntryValue;
  fn load(
    (
      block,
      burned,
...
pub(super) type JuneIdValue = (u64, u32);

impl Entry for JuneId {
  type Value = JuneIdValue;
...
pub(super) type JuneAddressBalance = (u128, u128);
