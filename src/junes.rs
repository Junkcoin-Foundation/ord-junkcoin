...
pub use {edict::Edict, june::June, june_id::JuneId, junestone::Junestone, terms::Terms};

pub(crate) use {etching::Etching, pile::Pile, spaced_june::SpacedJune};
...
mod tests {
  ...
  #[test]
  fn index_starts_with_no_junes() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
    context.assert_junes([], []);
  }

  #[test]
  fn default_index_does_not_index_junes() {
  ...
  #[test]
  fn empty_junestone_does_not_create_june() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
    ...
    context.rpc_server.broadcast_tx(TransactionTemplate {
      inputs: &[(1, 0, 0, Witness::new())],
      op_return: Some(Junestone::default().encipher()),
      ..Default::default()
    });
  ...
  #[test]
  fn etching_with_no_edicts_creates_june() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn etching_with_edict_creates_june() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn junes_must_be_greater_than_or_equal_to_minimum_for_height() {
    {
      let context = Context::builder()
          .arg("--index-junes")
          .build();
  ...
  #[test]
  fn etching_with_non_zero_divisibility_and_june() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn input_junes_may_be_allocated() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn etched_june_is_burned_if_an_unrecognized_even_tag_is_encountered() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn input_junes_are_burned_if_an_unrecognized_even_tag_is_encountered() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn unallocated_junes_are_assigned_to_first_non_op_return_output() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn unallocated_junes_in_transactions_with_no_junestone_are_assigned_to_first_non_op_return_output(
  ) {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn duplicate_junes_are_forbidden() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn outpoint_may_hold_multiple_junes() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn multiple_input_junes_on_the_same_input_may_be_allocated() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn multiple_input_junes_on_different_inputs_may_be_allocated() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn unallocated_junes_are_assigned_to_first_non_op_return_output_when_op_return_is_not_last_output(
  ) {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn june_rarity_is_assigned_correctly() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn edicts_which_refer_to_input_june_with_no_balance_are_skipped() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn edicts_may_transfer_junes_to_op_return_outputs() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn outputs_with_no_junes_have_no_balance() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn edicts_which_transfer_no_junes_to_output_create_no_balance_entry() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn allocate_all_remaining_junes_in_etching() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn allocate_all_remaining_junes_in_inputs() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
  ...
  #[test]
  fn junes_can_be_etched_and_claimed_in_the_same_transaction() {
    let context = Context::builder()
        .arg("--index-junes")
        .build();
